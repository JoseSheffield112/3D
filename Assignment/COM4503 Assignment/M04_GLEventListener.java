...
public class M04_GLEventListener implements GLEventListener {
  ...
  private void initialise(GL3 gl) {
    ...
    NameNode body = new NameNode("body");
      ...
      TransformNode bodyTransform = new TransformNode("body transform", m);
		...
		//Trying out my own class
		Robot mrRobot = new Robot(gl, bodyHeight, headScale);
		System.out.println(mrRobot.headNode());
  ...
  public void MOVETHEROBOT() {
	// robot class movement function handled here!
	// then we update - seems we need an update function in the class!
  }
  */
}